...
step = 10600
LORA_PATH = f"/upfs/user/lanchen/MaterialEdit/outputs/material_lora_topo_pbr_valid_score_17544_intersect_ref_metallic_1e-4/step-{step}.safetensors"
pipe.load_lora(pipe.dit, LORA_PATH)


test_json = "/upfs/user/lanchen/MaterialEdit/data_metallic/test.json"
images = []
prompts = []
edit_images = []
...
output_dir = f"/upfs/user/lanchen/MaterialEdit/outputs/material_lora_topo_pbr_valid_score_17544_intersect_ref_metallic_1e-4/val_step-{step}/"
...
for i in range(len(prompts)):
    ...
    if os.path.exists(output_path):
        continue
    # if 'realistic' not in image_path:
    #     continue
    if 'cloth' not in image_path:
        continue
    # if 'cloth' not in image_path and 
    # if 'weapon' not in image_path and 'machine' not in image_path:
    #     continue
