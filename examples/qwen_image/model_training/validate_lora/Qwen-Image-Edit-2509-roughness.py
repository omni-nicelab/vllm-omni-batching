...
step = 14900
LORA_PATH = f"/upfs/user/lanchen/outputs/material_lora_topo_pbr_valid_score_17544_intersect_ref_roughness_1e-4/step-{step}.safetensors"
pipe.load_lora(pipe.dit, LORA_PATH)


test_json = "/upfs/user/lanchen/MaterialEdit/data_roughness/test.json"
images = []
prompts = []
edit_images = []
...
output_dir = f"/upfs/user/lanchen/outputs/material_lora_topo_pbr_valid_score_17544_intersect_ref_roughness_1e-4/val_step-{step}/"
