...
export DIFFSYNTH_SKIP_DOWNLOAD=true  # Models already downloaded, skip modelscope API calls to avoid 40-process rate limiting
...
OUTPUT_PATH="/mnt/project/user/lan.chen/outputs/data_albedo_six_view_v2_filtered_high_sp_${TIMESTAMP}"
LORA_PATH="/mnt/project/user/lan.chen/outputs/data_albedo_six_view_v2_filtered_high_sp_20260227112428/step-2800.safetensors"
GPUS_PER_NODE=8
