...
Use it when enabling `step_execution=True` for a diffusion pipeline.
...
- Contract: [`vllm_omni/diffusion/models/interface.py`](../../../vllm_omni/diffusion/models/interface.py)
