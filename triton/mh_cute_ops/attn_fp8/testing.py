...
def attention_ref(
    ...
    # attention_drop.fill_(1.)
    # print("attention_drop shape: ", attention_drop.shape, "stride: ", attention_drop.stride())
    # vals = torch.arange(1, 8+1, dtype=attention_drop.dtype, device=attention_drop.device) * 0.1
    # attention_drop.view(-1, 8)[:] = vals

    # for i in range(32):
    #     print("attention_drop[", i, "] = ", attention_drop.flatten()[i])
    # exit(0)
