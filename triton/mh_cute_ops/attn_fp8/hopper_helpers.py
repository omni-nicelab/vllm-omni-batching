...
def gemm_zero_init(
    ...
    if const_expr(swap_AB):
        ...
        acc = cute.make_fragment(tiled_mma.partition_shape_C(shape), Int32 if int8 == True else Float32)
...
# Self-reference for `from .hopper_helpers import hopper_helpers` style imports
import sys
hopper_helpers = sys.modules[__name__]
