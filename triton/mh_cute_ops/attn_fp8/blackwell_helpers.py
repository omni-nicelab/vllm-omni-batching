...
try:
    from .mma_sm100_desc import mma_sm100_desc as sm100_desc
...
# Self-reference for `from .blackwell_helpers import blackwell_helpers` style imports
import sys
blackwell_helpers = sys.modules[__name__]
